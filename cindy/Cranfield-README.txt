...
- Lines beginning with .I mark the beginning of a query. The number after .I is the query ID. However, the relevance file does not use these query IDs. Instead, the query IDs are actually from 1 to 225. 
